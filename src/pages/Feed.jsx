...
const Feed = () => {
  const [posts, setPosts] = useState([
    {
      ...
      likes: 17,
      comments: [
        { user: 'Bhushan', text: 'Awesome work!', replies: [] },
        { user: 'vansh', text: "Can't wait to see it live!", replies: [] },
      ],
      shares: 3,
    },
    {
      id: 2,
      user: { name: 'Bhushan', avatar: 'B', bio: 'Chat Feature Lead | AI Enthusiast' },
      content: 'Unlocked "Math Wizard" badge after scoring 100% on the algebra quiz! Hard work pays off.',
      image: mathwiz,
      type: 'achievement',
      timestamp: '1h ago',
      likes: 10,
      comments: [{ user: 'Deepesh', text: 'Congrats, bro!', replies: [] }],
      shares: 2,
      achievementIcon: '🏆',
    },
  ]);
  ...
  const [leaderboard, setLeaderboard] = useState([
    ...
    { rank: '🔥', name: 'Aryan', avatar: 'B', posts: 10 },
  ...
  const [activityLog, setActivityLog] = useState([
    { type: 'like', text: 'Liked by Piyush', time: '1h ago' },
    { type: 'comment', text: 'Commented by Manas', time: '2h ago' },
  ]);
